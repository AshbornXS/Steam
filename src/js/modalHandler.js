...
//     account_info_container.style.background = 'rgb(var(--background))';
//   });
...
// 			ImportModuleAsync('../css/steam/settings/Millennium.css');
// 			ModalProps.InitializeProperties()
// 			return
// 		}

// 		ImportModuleAsync('../css/steam/settings/Settings.css');
